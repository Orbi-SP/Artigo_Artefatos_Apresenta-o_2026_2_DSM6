...
Nesse contexto, a utilização de tecnologias emergentes, como a Realidade Aumentada (RA), surge como uma alternativa capaz de complementar o processo de aprendizagem de maneira interativa e acessível. Diferentemente da Realidade Virtual, que cria ambientes totalmente digitais, a Realidade Aumentada permite integrar objetos virtuais ao ambiente físico real, proporcionando maior contextualização e acessibilidade ao usuário por meio de dispositivos móveis \cite{tori2006}.
...
Os resultados da pesquisa de campo contribuíram para corroborar a problemática que motivou o desenvolvimento do SAVIT. Conforme apresentado na Figura \ref{fig:pesquisa-q2}, apenas 26\% dos participantes afirmaram possuir sempre acesso adequado aos equipamentos necessários para aulas práticas. Embora 58\% tenham indicado acesso na maioria das vezes, 16\% relataram que raramente ou nunca dispõem desses recursos.
...
Quanto ao desenvolvimento da aplicação, os testes funcionais e qualitativos demonstraram o funcionamento das principais etapas previstas para o protótipo. O SAVIT apresenta um menu inicial que permite iniciar ou encerrar a experiência, seguido pela calibração da superfície e pelo posicionamento dos componentes tridimensionais no ambiente de Realidade Aumentada.

As Figuras \ref{fig:menu-savit} e \ref{fig:posicionamento-savit} apresentam, respectivamente, o menu inicial e a etapa de posicionamento dos componentes.

\begin{figure}[H]
    \centering
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{imgs/savit-menu-inicial.jpg}
        \caption{Menu inicial do SAVIT}
        \label{fig:menu-savit}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{imgs/savit-posicionamento-pecas.jpg}
        \caption{Posicionamento das peças em RA}
        \label{fig:posicionamento-savit}
    \end{minipage}
\end{figure}

Após o posicionamento, os modelos tridimensionais de memória RAM, placa-mãe e gabinete permanecem fixados no ambiente real, possibilitando sua visualização e posterior manipulação. A interação é realizada por reconhecimento gestual: ao fechar a mão, o sistema interpreta o gesto como a captura do componente, permitindo sua movimentação pelo espaço tridimensional.

\begin{figure}[H]
    \centering
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{imgs/savit-modelagem-3d.jpg}
        \caption{Componentes tridimensionais posicionados}
        \label{fig:modelagem-savit}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{imgs/savit-manipulacao-gestos.jpg}
        \caption{Manipulação de componente por gesto}
        \label{fig:gestos-savit}
    \end{minipage}
\end{figure}

Durante a montagem, o usuário movimenta a peça virtual até a região correspondente e realiza o gesto de abrir a mão para soltá-la. Quando o componente se encontra na área de encaixe prevista, o sistema realiza o posicionamento da peça no local correspondente. Essa funcionalidade encontra-se implementada, embora ainda apresente limitações de precisão durante determinadas interações.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.42\textwidth]{imgs/savit-encaixe-componentes.jpg}
    \caption{Encaixe dos componentes por interação gestual}
    \label{fig:encaixe-savit}
\end{figure}

Apesar dos resultados técnicos obtidos, o protótipo ainda apresenta limitações relacionadas à precisão do reconhecimento gestual, da movimentação e do encaixe dos componentes, além de oportunidades de melhoria quanto à estabilidade e ao desempenho da aplicação em diferentes dispositivos móveis. Os testes realizados foram funcionais e qualitativos, não havendo, nesta etapa, medições quantitativas de desempenho ou avaliações experimentais de aprendizagem com estudantes. Dessa forma, os resultados demonstram a viabilidade técnica do protótipo, mas ainda não permitem afirmar sua eficácia pedagógica.

% Conclusão
\section{Conclusão}

O desenvolvimento do SAVIT demonstrou a viabilidade técnica da utilização de Realidade Aumentada e visão computacional como suporte à simulação de atividades práticas de montagem de hardware. O protótipo desenvolvido possibilita o posicionamento de componentes tridimensionais em superfícies reais e a interação com esses objetos por meio de gestos capturados pela câmera do dispositivo móvel.

A pesquisa de campo realizada com estudantes da FATEC Registro também evidenciou limitações no acesso a equipamentos para atividades práticas e uma percepção favorável ao uso de tecnologias acessíveis como alternativa de apoio ao ensino. Esses resultados reforçam a relevância da problemática abordada pelo projeto, embora não representem uma avaliação da eficácia pedagógica do SAVIT.

Como limitações, destacam-se a ausência de métricas quantitativas de desempenho e de avaliações experimentais de aprendizagem, além da necessidade de aprimorar a precisão do reconhecimento gestual, da movimentação e do encaixe dos componentes e a estabilidade da aplicação em diferentes dispositivos móveis. Como trabalhos futuros, pretende-se ampliar a montagem do computador com novos componentes, aperfeiçoar a experiência em Realidade Aumentada e realizar avaliações com usuários para investigar a usabilidade e a contribuição da solução para o processo de aprendizagem.

% Agradecimentos
\section*{Agradecimentos}

Os autores agradecem à Faculdade de Tecnologia de Registro e ao Centro Paula Souza pelo apoio institucional ao desenvolvimento do projeto, bem como aos estudantes que participaram da pesquisa de campo e contribuíram para a compreensão da problemática investigada.
